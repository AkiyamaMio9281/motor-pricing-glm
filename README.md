...
and validation in Python. It ends in a credibility-checked rate table exported to Excel and
to a Power BI extract. 678,013 policy-years, 26,444 priced claims, 59.9 million of recorded
losses.
...
| L6 | Excel rate workbook, Power BI extract and page specification | `scripts/export_rate_workbook.py`, `docs/powerbi-spec.md` |
